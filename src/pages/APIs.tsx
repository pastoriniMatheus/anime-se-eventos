    ...
    const generateEndpoints = async () => {
      ...
      try {
        ...
        const supabaseEndpoints: Endpoint[] = [
          ...
          {
            name: 'WhatsApp Validation Callback',
            url: `https://${projectId}.supabase.co/functions/v1/whatsapp-validation-callback`,
            method: 'POST',
            description: 'Callback para validação WhatsApp',
            status: 'active',
            category: 'supabase',
            requiresAuth: false
          },
          ...
          {
            name: 'Message Delivery Webhook Endpoint',
            url: `https://${projectId}.supabase.co/functions/v1/message-delivery-webhook-endpoint`,
            method: 'POST',
            description: 'Endpoint para confirmação de entrega de mensagens',
            status: 'active',
            category: 'supabase',
            requiresAuth: false
          },
          ...
          },
          {
            ...
            url: `https://${projectId}.supabase.co/functions/v1/database-import`,
            method: 'POST',
            description: 'Importar dados CSV para o banco',
            status: 'active',
            category: 'supabase',
            requiresAuth: true
          },
          ...
          },
          {
            ...
            url: `https://${projectId}.supabase.co/functions/v1/generate-event-report`,
            method: 'POST',
            description: 'Gerar relatórios de eventos',
            status: 'active',
            category: 'supabase',
            requiresAuth: true
          }
        ...
        const restEndpoints: Endpoint[] = [
          ...
          {
            name: 'QR Codes API',
            url: `https://${projectId}.supabase.co/rest/v1/qr_codes`,
            method: 'GET/POST/PATCH/DELETE',
            description: 'CRUD para tabela de QR codes',
            status: 'active',
            category: 'supabase',
            requiresAuth: true
          },
          ...
          },
          {
            ...
            url: `https://${projectId}.supabase.co/rest/v1/system_settings`,
            method: 'GET/POST/PATCH/DELETE',
            description: 'CRUD para configurações do sistema',
            status: 'active',
            category: 'supabase',
            requiresAuth: true
          }
  ...
  const testEndpoint = async (endpoint: Endpoint) => {
    try {
      ...
      toast({
        ...
        description: `Endpoint ${endpoint.name} está respondendo`,
      });
    } catch (error) {
      toast({
        title: "Erro no teste",
        description: `Endpoint ${endpoint.name} não está acessível`,
        variant: "destructive"
      });
    }
  };
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">APIs & Endpoints</h1>
            <p className="text-muted-foreground">
              Gerencie e monitore todos os endpoints do sistema
            </p>
          </div>
          
          <Button onClick={refreshEndpoints} variant="outline">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total de Endpoints</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Supabase Functions</CardTitle>
